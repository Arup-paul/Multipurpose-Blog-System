...
<div class="wrapper" id="app">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
            <img src="{{asset('images/profilep/rofile.png')}}" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019- @php echo date('Y') @endphp <a href="http://github.com/arup-paul">Arup paul</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
